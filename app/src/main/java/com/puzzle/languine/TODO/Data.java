package com.puzzle.languine.TODO;
...
public class Data {
     ...
     */
    public static Exercise getExercise(String unitNumber, String exerciseName, Context context) {
        try {
    ...
    private static void setUpExercise(String text) {
        ...
        exercise = new Exercise(spanishDescription, englishDescription, numQuestions, typeOfQuiz);
